...
const RightSidebar: FC<PropsType> = ({
  ...
  return (
    <div className="hidden lg:inline-block relative flex-[0.7]">
      <div className="flex items-center w-full h-full pt-1 perspective-[1px] transform-style-preserve-3d [perspective-origin:right_top] pr-[8px]">
            ...
            <div className="flex flex-col items-center">
              <div className="w-full flex items-center justify-between mb-1">
                ...
                <Button
                  variant="default"
                  size="default"
                  className="flex items-center gap-1 w-auto ml-auto px-4 py-2 border-2 !border-primary text-white hover:bg-primary hover:text-white rounded-full dark:text-black"
                >
                  <Image
                    src={`/assets/plus.svg`}
                    alt="plus"
              ...
              <div className="flex items-center space-x-4 mt-2">
                <form className="flex items-center gap-3 w-full bg-white/10 dark:bg-gray-900 h-16 py-5 px-5 rounded-[15px] border-2 dark:border-gray-800">
                  <Image
                    ...
                    width={30}
                    height={30}
                    className="text-[#ddd] dark:invert"
                  />
